...
const questions = [
  {
    ...
    answers: [
      ...
      {
        text: "Cognitive, behavioral, and emotional well-being",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "Disturbances in a person's thinking, feeling, or behavior",
        correct: true,
      },
  ...
  {
    question:
      "Poor mental health increases the risk for long-lasting (chronic) physical conditions like Heart Disease, Stroke & Cancer, etc.",
    answers: [
  ...
  },
  {
    ...
    answers: [
      {
        text: "Reaching out and letting them know that help is available",
        correct: false,
      },
      { text: "Helping them access mental health services", correct: false },
      {
        text: "Learning and sharing facts, clear out myths if you are aware",
        correct: false,
      },
